...
<div class="card"><details><summary>▶ Binance API</summary><div style="margin-top:8px"><input class="input" id="apiKey" placeholder="Binance API Key"><input class="input" style="margin-top:7px" id="secretKey" placeholder="Binance Secret Key"><button class="btn" style="margin-top:7px" onclick="saveKeys()">SAVE</button></div></details></div><div class="card"><div class="m" id="radar">Radar: —</div><div class="bad" id="err"></div></div></div>
