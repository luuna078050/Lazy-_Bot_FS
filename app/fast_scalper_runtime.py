...
*{box-sizing:border-box}html,body{margin:0;background:#07101e;color:#eef3ff;font-family:Arial,Helvetica,sans-serif;overflow-x:hidden}body{min-width:320px}.wrap{width:100%;max-width:760px;margin:auto;padding:12px 14px 28px}.head{margin:0 0 12px}.brand{display:flex;gap:8px;align-items:flex-start}.bolt{font-size:37px;line-height:.9}.brand h1{margin:0;font-size:27px;line-height:1.05}.sub{margin-top:5px;color:#9aa6bd;font-size:13px;white-space:nowrap;overflow:hidden}.topbar{position:absolute;right:14px;top:14px}.online{background:#062d25;color:#00d47a;border-radius:8px;padding:5px 7px;font-size:10px;font-weight:800}.gear{margin-left:7px;color:#9eabc4;font-size:20px}.card{background:#101b2f;border:1px solid #29405f;border-radius:19px;padding:13px;margin-bottom:11px;overflow:hidden}.stats{display:grid;grid-template-columns:1fr 1fr;gap:8px}.metric{background:#091326;border-radius:13px;padding:10px 11px;min-width:0}.k{font-size:12px;color:#dbe3f3;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v{font-size:18px;font-weight:800;margin-top:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.unit{font-size:10px;color:#95a3bc;font-weight:400}.modes{display:grid;grid-template-columns:1fr 1fr 1fr;gap:7px;margin-top:9px}.btn{height:42px;border:0;border-radius:11px;color:#fff;background:#1763a9;font-size:11px;font-weight:800;padding:0 8px;cursor:pointer;min-width:0}.paper{background:#293b5a}.green{background:#00a85b}.red{background:#cb3049}.gray{background:#293a58}.note,.summary,.hint{color:#99a5bd;font-size:11px;margin-top:7px}.control1{display:grid;grid-template-columns:1fr 1fr .72fr .72fr;gap:7px}.input{height:42px;width:100%;background:#091326;border:1px solid #304767;border-radius:11px;color:#eef3ff;padding:0 10px;font-size:15px;outline:none;min-width:0}.profit{display:grid;grid-template-columns:1fr auto;gap:8px;align-items:center;margin-top:8px}.check{display:flex;align-items:center;gap:5px;font-size:13px;white-space:nowrap}.check input{width:19px;height:19px;accent-color:#1682ee}.actions{display:grid;grid-template-columns:1.45fr 1.15fr .8fr;gap:7px;margin-top:8px}.off{display:flex;align-items:center;gap:8px;margin-top:7px}.off .btn{width:85px;height:36px}.session{font-size:11px;color:#9aa6bd;white-space:nowrap}.status{min-height:15px;color:#9aa6bd;font-size:11px;margin-top:4px}.sectionHead,.slotHead,.collapseHead{display:flex;justify-content:space-between;align-items:center;gap:8px}.title{font-size:20px;font-weight:800;line-height:1.05}.badge{background:#c52f47;border-radius:8px;padding:4px 6px;font-size:8px;font-weight:800;white-space:nowrap}.empty{color:#8e9ab1;font-size:12px;margin-top:7px}.tradeitem{font-size:11px;color:#cbd5e7;padding:7px 2px;border-bottom:1px solid #2b405d;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.collapseHead{cursor:pointer}.collapseBtn{height:32px;border:1px solid #304767;border-radius:8px;background:#091326;color:#eef3ff;padding:0 9px;font-size:10px;font-weight:800}.pool{margin-top:9px;max-height:520px;overflow:auto}.rowline{display:grid;grid-template-columns:20px minmax(68px,1fr) 48px 42px 38px 58px;gap:4px;align-items:center;padding:6px 1px;border-bottom:1px solid #263a57;font-size:8px;min-width:0}.rowline>*{min-width:0;overflow:hidden;text-overflow:ellipsis}.pair{font-weight:800}.muted{color:#94a1b8}.addbtn{height:27px;border:0;border-radius:7px;background:#245b91;color:#fff;font-size:8px;font-weight:800;padding:0 5px;cursor:pointer}.auto{font-size:10px;color:#a4afc2;font-weight:800;display:flex;align-items:center;gap:5px}.auto input{width:18px;height:18px;accent-color:#1682ee}.slots{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:9px}.slotbox{display:grid;grid-template-columns:23px 1fr;gap:5px;align-items:center}.slotnum{font-size:9px;color:#75839c;text-align:center}.slot{height:39px;background:#091326;border:1px solid #304767;border-radius:10px;color:#edf3ff;padding:0 8px;font-size:12px;width:100%;min-width:0;outline:none}.slot:disabled{opacity:.8}.slotActions{display:flex;gap:7px;margin-top:8px}.slotActions .btn{height:36px}.slotActions .btn:first-child{flex:1}@media(max-width:520px){.online{display:none}.wrap{width:100%;max-width:none;padding:9px 10px 22px}.card{padding:10px;margin-bottom:9px;border-radius:15px}.brand h1{font-size:23px}.bolt{font-size:31px}.sub{font-size:10px}.metric{padding:8px 9px}.k{font-size:11px}.v{font-size:16px}.unit{font-size:9px}.modes{gap:5px}.btn{height:38px;font-size:9px;padding:0 6px}.control1{grid-template-columns:1fr 1fr;gap:5px}.input{height:38px;font-size:13px}.actions{gap:5px}.off{gap:6px}.title{font-size:17px}.tradeitem{font-size:10px;padding:6px 1px}.rowline{grid-template-columns:20px minmax(62px,1fr) 46px 40px 36px 56px;gap:3px;font-size:7px;padding:5px 0}.addbtn{height:25px;font-size:7px;padding:0 3px}.slots{gap:5px}.slot{height:36px;font-size:11px}.slotActions .btn{height:34px}.hint,.note,.summary,.session,.status{font-size:10px}.closepos{min-width:56px!important;height:28px!important;font-size:9px!important}}
.posrow{display:flex;align-items:center;gap:6px;white-space:nowrap}.posrow b{min-width:0;overflow:hidden;text-overflow:ellipsis}.pplus{color:#18c878;font-weight:800}.pminus{color:#ef5264;font-weight:800}.closepos{margin-left:auto;height:30px!important;min-width:62px!important;padding:0 8px!important;font-size:10px!important;flex:0 0 auto}</style></head><body><div class="topbar"><span class="online">● ONLINE</span><span class="gear">⚙</span></div><main class="wrap"><header class="head"><div class="brand"><span class="bolt">⚡</span><div><h1>Fast Scalper Beta</h1><div class="sub">Version 0.01 REPAIR PAPER · Trading TF: 3m</div></div></div></header>
...
<section class="card"><div class="title">Last Five</div><div id="lastTen"><div class="empty">No closed trades</div></div></section>
...
function renderLastTen(a){$('lastTen').innerHTML=a.length?a.slice(0,5).map((p,i)=>'<div class="tradeitem"><b>'+String(i+1).padStart(2,'0')+' · '+esc(p.symbol)+'</b> · '+num(p.stake)+' USDT · PnL '+num(p.pnl)+' USDT · '+esc(p.reason||'CLOSED')+'</div>').join(''):'<div class="empty">No closed trades</div>'}
