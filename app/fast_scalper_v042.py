...
RADAR_INTERVAL=60; ROTATE_SECONDS=60; MAX_POSITION_SECONDS=300; START_ACCOUNT=1850.0
...
def active_slot_count():
    return sum(1 for cfg in S['slots'] if cfg and cfg.get('symbol'))
...
async def manage_positions():
    ...
    for p in list(S['positions']):
        ...
        elif age>=ROTATE_SECONDS and live>=0:close_position(p,'ROTATION')
